   ...
   // cout<<face_num<<endl;
    ...
    for(int i=0; i<Adj.edges.size(); i++)
    {
     ...
     //   cout<<"f: "<<face_index1<<' '<<face_index2<<endl;
        sumcost = sumcost + 0.2*costV(face_index1, face_index2, tmplabel[face_index1][0], tmplabel[face_index2][0], W, 0.03);
    }
    cout<<"   sumcost: "<< sumcost<<endl;
    return sumcost;
}
  ...
  //  cout<<"alpha expansion"<<endl;
    ...
    for(int i=0; i<Adj.edges.size(); i++)
    {
        ...
        if(Adj.adj[t].size() == 2)
        {
            ...
            {
                g->add_node();
                double costv1 = costV(face_index1, face_index2, faceslabel[face_index1][0], label, W, 0.03);
                double costv2 = costV(face_index1, face_index2, label, faceslabel[face_index2][0], W, 0.03);
                double costv3 = costV(face_index1, face_index2, faceslabel[face_index1][0], faceslabel[face_index2][0], W, 0.03);
            ...
            else
            {
                ...
                double costv = costV(face_index1, face_index2, faceslabel[face_index1][0], label, W, 0.03);
